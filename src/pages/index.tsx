  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of mobility with Car Sharing Application. A platform designed to make car sharing seamless, efficient, and convenient for everyone."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of mobility with Car Sharing Application. A platform designed to make car sharing seamless, efficient, and convenient for everyone.`}
            </Text>
            <Box
